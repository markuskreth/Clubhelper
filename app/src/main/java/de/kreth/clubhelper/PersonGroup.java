...
public class PersonGroup {
    ...
    private transient PersonGroupDao myDao;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getPersonGroupDao() : null;
    }
    ...
    public List<Group> getGroupList() {
        if (groupList == null) {
            ...
            List<Group> groupListNew = targetDao._queryPersonGroup_GroupList(id);
            synchronized (this) {
                if(groupList == null) {
    ...
    public List<Person> getPersonList() {
        if (personList == null) {
            ...
            List<Person> personListNew = targetDao._queryPersonGroup_PersonList(id);
            synchronized (this) {
                if(personList == null) {
