...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        PersonGroupDao.dropTable(db, ifExists);
        SynchronizationDao.dropTable(db, ifExists);
        DeletedEntriesDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(PersonGroupDao.class);
        registerDaoClass(SynchronizationDao.class);
        registerDaoClass(DeletedEntriesDao.class);
    }
