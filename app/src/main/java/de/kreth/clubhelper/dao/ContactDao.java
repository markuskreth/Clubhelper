...
public class ContactDao extends AbstractDao<Contact, Long> {
    ...
    */
    ...
    protected void bindValues(SQLiteStatement stmt, Contact entity) {
        ...
        if (syncStatus != null) {
            stmt.bindLong(7, syncStatusConverter.convertToDatabaseValue(syncStatus));
        }
    }
    ...
    public Contact readEntity(Cursor cursor, int offset) {
        Contact entity = new Contact( //
            ...
            cursor.isNull(offset + 6) ? null : syncStatusConverter.convertToEntityProperty(cursor.getInt(offset + 6)) // syncStatus
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Contact entity, int offset) {
        ...
        entity.setSyncStatus(cursor.isNull(offset + 6) ? null : syncStatusConverter.convertToEntityProperty(cursor.getInt(offset + 6)));
     }
