...
public class AdressDao extends AbstractDao<Adress, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Adress1 = new Property(1, String.class, "adress1", false, "ADRESS1");
        public final static Property Adress2 = new Property(2, String.class, "adress2", false, "ADRESS2");
        ...
        public final static Property Changed = new Property(6, java.util.Date.class, "changed", false, "CHANGED");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ADRESS\" (" + //
                ...
                "\"CHANGED\" INTEGER NOT NULL ," + // 6: changed
    ...
    protected void bindValues(SQLiteStatement stmt, Adress entity) {
        ...
        stmt.bindLong(7, entity.getChanged().getTime());
        stmt.bindLong(8, entity.getCreated().getTime());
 
        SyncStatus syncStatus = entity.getSyncStatus();
        if (syncStatus != null) {
            stmt.bindLong(9, syncStatusConverter.convertToDatabaseValue(syncStatus));
        }
    }
    ...
    public Adress readEntity(Cursor cursor, int offset) {
        Adress entity = new Adress( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // adress1
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // adress2
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // plz
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // city
            cursor.getLong(offset + 5), // personId
            new java.util.Date(cursor.getLong(offset + 6)), // changed
            new java.util.Date(cursor.getLong(offset + 7)), // created
            cursor.isNull(offset + 8) ? null : syncStatusConverter.convertToEntityProperty(cursor.getInt(offset + 8)) // syncStatus
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Adress entity, int offset) {
        ...
        entity.setChanged(new java.util.Date(cursor.getLong(offset + 6)));
        entity.setCreated(new java.util.Date(cursor.getLong(offset + 7)));
        entity.setSyncStatus(cursor.isNull(offset + 8) ? null : syncStatusConverter.convertToEntityProperty(cursor.getInt(offset + 8)));
     }
